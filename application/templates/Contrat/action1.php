				...
				<tr>
					...
					<td>
						<?php 
							...
							$ind=$_POST['id'];
							?>
							<strong><?php echo ucfirst($data[$ind]['titre_hote']);?></strong>
							<?php
							echo ' ';
							?>
							<strong><?php echo ucfirst($data[$ind]['nom_hote']);?></strong>
							<?php
							echo ' ';
							?>
							<strong><?php echo  ucfirst($data[$ind]['prenom_hote']); ?></Strong>
							<?php
							echo '<br>';
							?>
							<strong><?php echo 'né le : '.$data[$ind]['datenaissance_hote'];?></Strong>
							<?php
							echo '<br>';
							?>	
							<strong><?php echo  $data[$ind]['adresse_hote'];?></Strong>							
							<?php
							echo '<br>';
							?>
							<strong><?php echo  $data[$ind]['email_hote'];?></Strong>
							<?php
							echo '<br>';?>
					...
					<!-- Droite -->
					<td style="text-align: top-right; padding-left : 320px;">
						<strong><?php echo 'N° SS : '.$data[$ind]['ss_hote'];?></Strong>
						<?php echo '<br>';?>
						<strong><?php echo  $data[$ind]['nationalite_hote'];?></Strong>
						<?php echo '<br>';?>
						<strong><?php echo 'QUALIFICATION :';?></Strong><i><?php echo' Hôtesse d\'accueil standard';?></i>
						<?php echo '<br>';?>
						<strong><?php echo 'CATÉGORIE:';?></Strong><i><?php echo' Employe CDD';?></i>
					</td>
				</tr>
			</table>
			<!-- Deuxième table -->
			...
			<table >
				<tr>
					<td>
						...
						La caisse de retraite complémentaire à laquelle <strong><?php echo ucfirst($data[$ind]['titre_hote']).' '.ucfirst( $data[$ind]['nom_hote']).' '.ucfirst($data[$ind]['prenom_hote']); ?> </strong>   est affiliée est (A REMPLIR PAR WALID)  . Il bénéficiera du régime de 
