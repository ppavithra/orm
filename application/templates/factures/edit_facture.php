...
<div><span class="titretable">Nombres :</span> <br>
    Jours : <input type="text" class="inputtableau" name="nombre_jours" required><br><br>
    Personnes : <input type="text" class="inputtableau" name="quantite" required><br><br>
    Heures : <input type="text" class="inputtableau" name="quantite" required><br>
    </div><br>
<div><span class="titretable">Tarif U. HT :</span> <input type="text" class="inputtableau" name="tarif_unitaire" required></div><br>
<div><span class="titretable">Total HT :</span> <input type="text" class="inputtableau" name="ligne_total_ht" ></div><br>
...
<div><span class="titretable">Total HT :</span> <input type="text" class="inputtableau" name="colonne_total_ht"disabled="disabled"></div><br>
<div><span class="titretable">TVA 20% :</span> <input class="inputtableau" type="text" name="tva" disabled="disabled" ></div><br>
<div><span class="titretable">Total TTC :</span> <input type="text" class="inputtableau" name="total" disabled="disabled"></div><br>
